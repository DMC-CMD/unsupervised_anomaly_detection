...
from evaluation_helper import get_labels_and_quantization_errors, display_reconstruction_errors, display_roc, \
    get_auc_score, get_minimal_anomaly_score, display_confusion_matrix

with open('Models/MIMII/base_model.p', 'rb') as file:
...
display_reconstruction_errors(labels, quantization_errors, 'Quantization errors for SOM with MIMII data')
